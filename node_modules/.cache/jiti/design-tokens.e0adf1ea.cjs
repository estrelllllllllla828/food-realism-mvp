"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.SPRING_TAB_ICON = exports.SPRING_STAGGER = exports.SPRING_SLIDE = exports.SPRING_FLOAT = exports.SPRING_FAB = exports.SPRING_BUTTON = exports.SPACING = exports.SIZE = exports.SHADOW_TOKENS = exports.SHADOW_LAYERS = exports.SHADOW_CLAY_RAISED_SM = exports.SHADOW_CLAY_NAV = exports.SHADOW_CLAY_INSET_DEEP = exports.SHADOW_CLAY_INSET = exports.SHADOW_CLAY_HANDLE_PRESSED = exports.SHADOW_CLAY_HANDLE = exports.SHADOW_CLAY_FAB_PRESSED = exports.SHADOW_CLAY_FAB = exports.SHADOW_CLAY_CARD_PRESSED = exports.SHADOW_CLAY_CARD = exports.SHADOW_CLAY_CAPSULE = exports.SHADOW_CLAY_BUTTON_PRIMARY_PRESSED = exports.SHADOW_CLAY_BUTTON_PRIMARY = exports.RADIUS = exports.MOTION = exports.COLORS = void 0; /** Central design tokens ? single source of truth for clay UI */
...
const SHADOW_LAYERS = exports.SHADOW_LAYERS = {
...
const SHADOW_CLAY_CARD = exports.SHADOW_CLAY_CARD = [
SHADOW_LAYERS.highlightSoft,
SHADOW_LAYERS.coreWarmMd,
SHADOW_LAYERS.dropWarmSm].
join(', ');

const SHADOW_CLAY_CARD_PRESSED = exports.SHADOW_CLAY_CARD_PRESSED = [
`inset 6px 6px 14px ${COLORS.shadow.coreWarm}`,
`inset -2px -2px 6px ${COLORS.shadow.highlight}`,
`0 2px 6px ${COLORS.shadow.dropSoft}`].
join(', ');

const SHADOW_CLAY_RAISED_SM = exports.SHADOW_CLAY_RAISED_SM = [
`inset 3px 3px 8px ${COLORS.shadow.highlight}`,
SHADOW_LAYERS.coreWarmSm,
SHADOW_LAYERS.dropWarmSm].
join(', ');

const SHADOW_CLAY_INSET = exports.SHADOW_CLAY_INSET = [
`inset 5px 5px 12px ${COLORS.shadow.coreWarm}`,
`inset -3px -3px 8px ${COLORS.shadow.highlight}`].
join(', ');

const SHADOW_CLAY_INSET_DEEP = exports.SHADOW_CLAY_INSET_DEEP = [
`inset 6px 6px 16px ${COLORS.shadow.coreWarm}`,
`inset -4px -4px 10px ${COLORS.shadow.highlight}`].
join(', ');

const SHADOW_CLAY_NAV = exports.SHADOW_CLAY_NAV = [
`inset 0 6px 12px ${COLORS.shadow.highlight}`,
SHADOW_LAYERS.coreWarmSm,
SHADOW_LAYERS.dropWarmMd].
join(', ');

const SHADOW_CLAY_FAB = exports.SHADOW_CLAY_FAB = [
SHADOW_LAYERS.highlightSoft,
SHADOW_LAYERS.coreCheese,
SHADOW_LAYERS.dropWarmSm].
join(', ');

const SHADOW_CLAY_FAB_PRESSED = exports.SHADOW_CLAY_FAB_PRESSED = [
`inset 6px 6px 14px ${COLORS.shadow.coreCheese}`,
`inset -2px -2px 6px ${COLORS.shadow.highlight}`,
`0 2px 6px ${COLORS.shadow.dropSoft}`].
join(', ');

const SHADOW_CLAY_BUTTON_PRIMARY = exports.SHADOW_CLAY_BUTTON_PRIMARY = [
'inset 4px 4px 10px rgba(255, 200, 190, 0.4)',
`inset -4px -6px 12px ${COLORS.shadow.coreTomato}`,
`0 6px 16px ${COLORS.shadow.dropSoft}`].
join(', ');

const SHADOW_CLAY_BUTTON_PRIMARY_PRESSED = exports.SHADOW_CLAY_BUTTON_PRIMARY_PRESSED = [
`inset 7px 7px 16px ${COLORS.shadow.coreTomato}`,
'inset -2px -2px 6px rgba(255, 200, 190, 0.35)',
`0 2px 6px ${COLORS.shadow.dropSoft}`].
join(', ');

const SHADOW_CLAY_CAPSULE = exports.SHADOW_CLAY_CAPSULE = [
'inset 2px 2px 5px rgba(255, 255, 255, 0.55)',
`inset -2px -3px 5px ${COLORS.shadow.coreWarm}`,
SHADOW_LAYERS.dropWarmSm].
join(', ');

const SHADOW_CLAY_HANDLE = exports.SHADOW_CLAY_HANDLE = SHADOW_CLAY_RAISED_SM;
const SHADOW_CLAY_HANDLE_PRESSED = exports.SHADOW_CLAY_HANDLE_PRESSED = SHADOW_CLAY_INSET_DEEP;

const SHADOW_TOKENS = exports.SHADOW_TOKENS = {
...
const SPRING_BUTTON = exports.SPRING_BUTTON = { type: 'spring', stiffness: 520, damping: 26, mass: 0.75 };
const SPRING_FAB = exports.SPRING_FAB = { type: 'spring', stiffness: 600, damping: 22, mass: 0.85 };
const SPRING_STAGGER = exports.SPRING_STAGGER = { type: 'spring', stiffness: 380, damping: 24, mass: 0.9 };
const SPRING_FLOAT = exports.SPRING_FLOAT = { type: 'spring', stiffness: 120, damping: 12, mass: 0.6 };
const SPRING_TAB_ICON = exports.SPRING_TAB_ICON = { type: 'spring', stiffness: 480, damping: 18, mass: 0.5 };
const SPRING_SLIDE = exports.SPRING_SLIDE = { type: 'spring', stiffness: 340, damping: 32, mass: 1 }; /* v9-0eb77647b0477aa8 */
